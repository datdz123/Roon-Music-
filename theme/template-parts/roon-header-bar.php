 ...
 */
?>
<div class="flex items-center h-roon-header min-h-roon-header px-5 border-b border-gray-200 bg-white gap-3 z-40 flex-shrink-0 font-inter">
    ...
    <div id="roon-page-title" class="flex-1 text-[13px] font-medium text-gray-600 text-center"></div>
    ...
    <div class="flex items-center gap-2">
        ...
        <!-- Search -->
        <button id="btn-global-search" title="Search"
                class="flex items-center justify-center w-8 h-8 rounded-md text-gray-400 hover:bg-gray-100 hover:text-gray-700 transition-colors">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
